        ...
        <div class="card-body">
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title_en" value="{{ old('title_en') }}"
                        required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description_en" rows="3" required>{{ old('description_en') }}</textarea>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description_fr" rows="3" required>{{ old('description_fr') }}</textarea>
